...
namespace demo_gym
{
    public partial class Form18: Form
    {
        ...
        private void ButtonLoad_Click_Click(object sender, EventArgs e)
        {
            LoadExpiredSubscriptions();
        }
        private void LoadExpiredSubscriptions()
        {
            ...
            {
                connection.Open();
                string query = "SELECT client_id, type, start_date, end_date, active, price, status FROM public.subscriptions WHERE status LIKE '%истекший%'";
